...
public class BitmapCache implements ImageLoader.ImageCache {
    ...
    /**
     * Find and return an existing BitmapCache stored in a {@link com.bluepixel.android.sgpool.util.BitmapCache.RetainFragment}, if not found a
     * new one is created using the supplied params and saved to a {@link com.bluepixel.android.sgpool.util.BitmapCache.RetainFragment}.
     *
